...
public class LoginPageAtHome3 {
    private WebDriver driver;
    private WebDriverWait wait;

    public LoginPageAtHome3(WebDriver driver) {
        this.driver = driver;
    ...
    public MainPageAtHome3 loginToApplication(String username, String password) {
        getEmailField().sendKeys(username);
        getPasswordField().sendKeys(password);
        getLoginButton().click();
        return new MainPageAtHome3(driver);
    }
