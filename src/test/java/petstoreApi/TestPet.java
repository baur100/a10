...
public class TestPet {
    ...
    public void createPet(){
        ...
        Assert.assertEquals(pet.getTags()[0].getId(),responsePet.getTags()[0].getId());
...
//        Assert.assertEquals(updatedPet.getTags()[0].getId(),responsePet.getTags()[0].getId());
//        Assert.assertEquals(updatedPet.getPhotoUrls(),responsePet.getPhotoUrls());
//    }
}
