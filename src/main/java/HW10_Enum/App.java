...
public class App {
    public static void main(String[] args) {
        Car mycar=new Car("Toyota","Camry",Manufacturer.JAPAN);
        System.out.println(mycar.getBrand());

        mycar.printinfo();//Вызываем функцию печать всех полей класса Car
        ...
        canadian.printinfo();//Вызываем функцию печать всех полей с Array в поле (исп.Луп)
